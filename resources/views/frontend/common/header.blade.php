                            ...
                            <div class="col-xl-2 col-lg-12 col-md-5 col-sm-5 col-xs-5">
                                <div class="logobox">
                                    <a href="{{ url('/') }}" class="logo navbar-brand">
                                        <img src="{{asset('assets/images/ecore/logo/ecore-logo.webp')}}" alt="ecore"
                                ...
                                <div class="navbar_content d-flex align-items-center">
                                    <ul class="navbar_nav">
                                        ...
                                        <li class="menu-item menu-item-has-children dropdown  nav-item">
                                            ...
                                            <ul class="sub_menu">
                                                <li class="menu-item nav-item">
                                                    <a href="{{url('/hardwaresupport')}}" class="nav_link">
                                                        <span class="text-link">
                                                            Hardware Support
                                                        </span>
                                                    </a>
                                                ...
                                                <li class="menu-item nav-item">
                                                    <a href="{{url('/networksecurity')}}" class="nav_link">
                                                        <span class="text-link">
                                                            Network & Security
                                                        </span>
                                                    </a>
                                                ...
                                                <li class="menu-item nav-item">
                                                    <a href="{{url('/cctv')}}" class="nav_link">
                                                        <span class="text-link">
                                                            CCTV Survelliance
                                                        </span>
                                                    </a>
