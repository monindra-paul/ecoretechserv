...
<div class="page-content-wrapper">
    <div class="page-content">
        <div class="col-xl-9 mx-auto">
            <h6 class="mb-0 text-uppercase">Update Token</h6>
            <hr>
            <div class="card border-top border-0 border-4 border-info">
                <div class="card-body">
                    <div class="border p-4 rounded">
                        ...
                        <form action="{{url('/admintokens/update/' .$tokens->id)}}" method="post">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="mobile"
                                        placeholder="Enter Mobile Number" name="mobile"  value="{{$tokens->mobile}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="invoice_no"
                                        placeholder="Enter Invoice No." name="invoice_no"  value="{{$tokens->invoice_no}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="invoice_date"
                                        placeholder="Enter Invoice Date"value="{{\Carbon\Carbon::parse($tokens->invoice_date)->format('d M, Y')}}" name="invoice_date">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="product_name"
                                        placeholder="Enter Product Name" name="product_name" value="{{$tokens->product_name}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="serial_no"
                                        placeholder="Enter Serial Number" name="serial_no" value="{{$tokens->serial_no}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="model_no" placeholder="Enter Model No."
                                        name="model_no" value="{{$tokens->model_no}}">
                                </div>
                            </div>


                            <div class="row mb-3">
                                <label for="warranty_info" class="col-sm-3 col-form-label" id="warranty_info">Work Progress
                                </label>                               
                                <div class="col-sm-9">
                                    <select class="form-select mb-3" aria-label="Default select example"
                                        name="warranty_info">
                                        <option selected="">Work Progress</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="address" rows="3" placeholder="Enter Address"
                                        name="address">{{$tokens->address}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="issue" rows="3" placeholder="Enter Issue"
                                        name="issue">{{$tokens->issue}}</textarea>
                                </div>
                            </div>
